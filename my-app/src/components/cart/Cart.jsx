...
const Cart = (props) => {
  const onAddOverlay = async (obj) => {
    try {
      ...
      if (findOverlay) {
        axios.delete(
          `https://63808d76786e112fe1b31627.mockapi.io/cart/${findOverlay.id}`
        );
        ...
        const { data } = await axios.post(
          "https://63808d76786e112fe1b31627.mockapi.io/cart",
          obj
        );
  ...
  const onAddFav = async (obj) => {
    try {
      ...
      if (findFavorites) {
        axios.delete(
          `https://63808d76786e112fe1b31627.mockapi.io/favorites/${findFavorites.id}`
        );
        ...
        const { data } = await axios.post(
          "https://63808d76786e112fe1b31627.mockapi.io/favorites",
          obj
        );
